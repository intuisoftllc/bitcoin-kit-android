...
interface IUnspentOutputSelector {
    ...
    fun select(unspentOutputs: List<Pair<Long, String>>, value: Long, feeRate: Int, outputType: ScriptType = ScriptType.P2PKH, changeType: ScriptType = ScriptType.P2PKH, senderPay: Boolean, dust: Int, pluginDataOutputSize: Int): SelectedUnspentOutputInfo
}
...
class UnspentOutputSelectorChain : IUnspentOutputSelector {
    ...
    override fun select(
        unspentOutputs: List<Pair<Long, String>>,
        value: Long,
        feeRate: Int,
